...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pycep-parser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pycep-parser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pycep-parser
# for installing globally
pixi global install pycep-parser
```
...
It is possible to list all of the versions of `pycep-parser` available on your platform:
...
```
pixi search pycep-parser --channel conda-forge
```
